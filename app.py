...
def check_superficial_loss(
    ...
    # Edge case: Identical properties (Different ETFs tracking the same index)
...
if 'history' not in st.session_state:
    ...
    st.session_state.history = pd.DataFrame({
        'Date': pd.to_datetime(['2026-02-15', '2026-02-20', '2026-03-01', '2026-02-25', '2026-02-28', '2026-02-15', '2026-03-01']),
        'Ticker': ['SHOP', 'XEQT', 'SHOP', 'VFV.TO', 'ZSP.TO', 'XUU.TO', 'VUN.TO'],
        'Action': ['BUY', 'BUY', 'BUY', 'BUY', 'BUY', 'BUY', 'BUY'],
        'Shares': [10, 50, 15, 100, 50, 200, 150],
        'Price': [105.00, 32.00, 98.50, 130.00, 75.00, 45.00, 80.00],
        'Account': ['Self-Directed TFSA', 'Self-Directed RRSP', 'Self-Directed TFSA', 'Self-Directed Margin', 'Self-Directed TFSA', 'Self-Directed RRSP', 'Self-Directed Margin']
    })
...
SUPPORTED_TICKERS = ['SHOP', 'XEQT', 'AAPL', 'MSFT', 'TSLA', 'RY', 'TD', 'VFV.TO', 'ZSP.TO', 'XUU.TO', 'VUN.TO']
